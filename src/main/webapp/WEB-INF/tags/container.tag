        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-info fa-fw"></i> 育儿学堂<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 校园吧<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="${ctx}/admin/news/news-list?t=ballot&mode=7">列表</a>
                            </li>
                            <li>
                                <a href="${ctx}/admin/news/news-publish?t=ballot&mode=7">发布</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
